---
title: "Density plot all activities_Boxplot"
author: "Joao Pinelo Silva"
date: "September 8, 2016"
output: pdf_document
---

`(Activities Boxplot with Sol)`
...
ggplot(data=xa, aes(x=activity, y=int800, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
# Int 1600
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=int1600, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
# Int 3200
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=int3200, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
...
```{r,  fig.height=7, fig.width=6, message=FALSE}
library(ggplot2)
ggplot(data=xa, aes(x=activity, y=int_n, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
...
# Ch 800
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=log10(ch800)+1, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
# Ch 1600
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=log10(ch1600)+1, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
# Ch 3200
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=log10(ch3200)+1, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
\newpage
# Ch n
```{r,  fig.height=7, fig.width=6, message=FALSE}
ggplot(data=xa, aes(x=activity, y=log10(ch_n)+1, colour=activity)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.2), colour="#b2b2b2", alpha=0.3)
```
