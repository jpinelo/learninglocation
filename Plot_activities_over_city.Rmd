---
title: "Plot All Activities Over City Map - Global Measures"
...
library(ggplot2)
plot_base <- ggplot() +
  geom_point(data=sg1, aes(x=T1024_Integration, y=log10(T1024_Choice)), color = "#cccccc", alpha=0.7) +
  geom_vline(xintercept=mean(sg1$T1024_Integration), linetype="dotted") +
  geom_hline(yintercept=mean(log10(sg1$T1024_Choice)), linetype="dotted")
```

# Plot All Activities
```{r, fig.height=8, fig.width=6, message=FALSE }
plot_base+
  geom_point(data=sol1, aes(x= int_n, y=log10(ch_n)), color="#e86af0", alpha=0.5) +
  geom_point(data=starbucks1, aes(x= int_n, y=log10(ch_n)), color="#74d600", alpha=0.5) +
  geom_point(data=med1, aes(x= int_n, y=log10(ch_n)), color="#7bb3ff", alpha=0.5) +
  geom_point(data=hosp1, aes(x= int_n, y=log10(ch_n)), color="#d11141", alpha=0.5) +
  geom_point(data=hair1, aes(x= int_n, y=log10(ch_n)), color="#ffc425", alpha=0.5) +
  geom_point(data=pedu1, aes(x= int_n, y=log10(ch_n)), color="#f37735", alpha=0.5) +
  geom_point(data=pubs1, aes(x= int_n, y=log10(ch_n)), color="#c68642", alpha=0.5) +
  geom_point(data=trav1, aes(x= int_n, y=log10(ch_n)), color="#fe5757", alpha=0.5) +
  geom_point(data=cafes1, aes(x= int_n, y=log10(ch_n)), color="#8d5524", alpha=0.5) +
  geom_point(data=waterstones1, aes(x= int_n, y=log10(ch_n)), color="#5f9ea0", alpha=0.5)
```
City: `r  nrow(sg1)`
Events: `r sum(nrow(sol1), nrow(starbucks1), nrow(med1), nrow(hosp1), nrow(hair1), nrow(pedu1), nrow(pubs1), nrow(trav1))`
\newpage
# Plot Solicitors
```{r, fig.height=8, fig.width=6, message=FALSE}
plot_base +
